...
def rotate_mesh_around_axis(mesh, rot: list, renderer, dist: float = 3.5, save: str = "", device: str = ""):
    ...
    if save:
        verts, faces = mesh.get_mesh_verts_faces(0)
        save_obj(join(meshes_path,f'{name}.obj'), verts, faces)
    return mesh

def translate_mesh_on_axis(mesh, t: list, renderer, dist: float = 3.5, save: str = ""):
...
def load_meshes(meshes_path: str = "./data/meshes") -> dict:
